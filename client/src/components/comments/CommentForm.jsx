  ...
  if (!user) {
    return (
      <p className="text-sm text-slate-500">
        <Link to="/login" className="text-indigo-600 hover:text-indigo-700">Log in</Link> to comment.
      </p>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <textarea
        ...
        className="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-sm resize-y focus:outline-none focus:ring-2 focus:ring-indigo-600"
      />
